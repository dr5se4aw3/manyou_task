...
ActiveRecord::Schema.define(version: 2020_03_11_064109) do
  ...
  create_table "label_on_tasks", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_label_on_tasks_on_user_id"
  end
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.date "deadline", default: "1000-01-01", null: false
  ...
  add_foreign_key "label_on_tasks", "users"
